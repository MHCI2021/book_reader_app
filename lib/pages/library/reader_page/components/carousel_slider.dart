...
class CarouselSliderState extends State<CarouselSlider>
  ...
  print("panUp");
    readerController.isScrolling=false;
    readerController.setIndex(carouselState.pageController.page.round());
     if(readerController.isPlaying )readerController.play();
  
    
  }
  void onPanDown() {
    print("panDown");
    readerController.pause(scrolling: true);
    ...
    return getGestureWrapper(
      ...
      onPageChanged: (int index) async {
        int currentPage = getRealIndex(index + carouselState.initialPage,
            ...
            //await flutterTts.speak(widget.items[index]);
        ...
        return AnimatedBuilder(
          ...
          builder: (BuildContext context, child) {
            double distortionValue = 1.0;
              ...
              final distortionRatio = (itemOffset.abs()>1.0)? relSize:(1 - (itemOffset.abs() * 0.3)).clamp(relSize, 1.0);
